...
namespace BE.Migrations
{
    ...
    [Migration("20241023073820_serviceDetail")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BE.src.Domains.Models.SerivceDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");

                    b.Property<Guid>("AmenitySerivceId")
                        .HasColumnType("char(36)");
                    ...
                    b.HasIndex("AmenitySerivceId");

                    b.ToTable("SerivceDetails");
                });
            ...
            modelBuilder.Entity("BE.src.Domains.Models.BookingItem", b =>
                {
                    ...
                    b.HasOne("BE.src.Domains.Models.SerivceDetail", "SerivceDetail")
                        .WithMany("BookingItems")
            ...
            modelBuilder.Entity("BE.src.Domains.Models.SerivceDetail", b =>
                {
                    b.HasOne("BE.src.Domains.Models.AmenityService", "AmenityService")
                        .WithMany("SerivceDetails")
                        .HasForeignKey("AmenitySerivceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
