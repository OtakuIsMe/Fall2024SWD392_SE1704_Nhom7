...
const Modal:React.FC<PopupType> = ({type, closeModal, editRoom, deleteRoom, room }) => {
  ...
  const handlePriceChange = (event: React.ChangeEvent<HTMLInputElement>) => setPrice(Number(event.target.value));
              ...
              <div className="content">
                ...
                <div className="column2">
                  ...
                  <label>
                    ...
                    <TextField name="price" variant="outlined" size="small" fullWidth value={price} onChange={handlePriceChange}/>
                  </label>
                  <label>
                    <div style={{display: "flex", height: "fit-content", alignItems: "center"}}>
                      <p>Description</p>
